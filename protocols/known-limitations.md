...
| **PROTOCOLS.md as routing copy** | Transitional | PROTOCOLS.md duplicates the AGENTS.md Protocol Index for paste-only sessions. Scheduled for consolidation in the v12 restructure (single trigger table). |
