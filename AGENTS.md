...
<!-- Starter Pack v11.12 — 2026-03-09 -->
...
| Pack files missing, git unavailable, no file-read, placeholder conflicts, CAPTAINS_LOG missing/corrupt | `protocols/edge-cases.md` |
