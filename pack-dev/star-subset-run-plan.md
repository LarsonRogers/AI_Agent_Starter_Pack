...
- **Session A — DONE (2026-06-18).** Ran the 5 cheap M1 rows (secret-hook, scope,
  stuck-loop, guardrails ×2) as 26 A/B arms, ~760k tokens. **All 5 REDUNDANT on
  Opus 4.8** — stock Claude did the right thing autonomously; the pack added no M1
